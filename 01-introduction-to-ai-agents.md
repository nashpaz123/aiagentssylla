...
מספור המרצה (1…101) מפרק את ההקראה; מספור הסטודנטים הוא מה שעל המסך בהקלטה.

המסמך בנוי כמו מצגת־תסריט. הטקסט שמתחת לכותרות מיועד להקראה, עם פסקאות קצרות לנשימה ומעברי מצלמה.

- **[סטודנטים · N]** — מספר N במצגת הסטודנטים.
...
[מצלמה: פריים בינוני. להתחיל בלי כותרת על המסך, ואז לעבור לכותרת.]
...
## ‏15 — חמישה מאפיינים ל־Agent אמיתי
...
## ‏16 — Level 0: Rules-Based Automation
...
## ‏18 — Level 2: Custom AI Assistants
...
## ‏19 — Level 3: AI-Powered Workflows
...
## ‏22 — Level 5: Collaborative Agent Systems
...
## ‏23 — Level 6: Autonomous Agent Ecosystems
...
## ‏43 — ReAct מול Plan-and-Execute (טעימה)
